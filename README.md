...
1. Clone the repository
   ```bash
   git clone https://github.com/ahmedousdi1/iot-hospital-monitoring.git
...
3. Set up environment variables in a `.env` file (see `.env` for required keys — never commit this file)

4. Run the backend
   ```bash
   python backend_appli.py
   ```

5. Flash `envi_node.py`, `patient_node.py`, and `rfid_node.py` to their respective sensor devices

6. Open the dashboard in your browser at the address shown in the terminal
